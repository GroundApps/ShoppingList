...
public class PredictionDbAdapterItem {

    public static final String KEY_ROWID = "_id";
    public static final String KEY_ITEM = "itemTitle";

    private static final String TAG = "PredictionDbAdapterItem";
    ...
    public PredictionDbAdapterItem(Context ctx) {
        this.mCtx = ctx;
    }

    public PredictionDbAdapterItem open() throws SQLException {
    ...
    public boolean delete(String name){
        return mDbHelper.getWritableDatabase().delete(SQLITE_TABLE, KEY_ITEM + " = ?", new String[] { name }) > 0;
    }
